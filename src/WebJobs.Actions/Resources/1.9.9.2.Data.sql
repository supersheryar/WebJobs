...
IF NOT EXISTS (SELECT 1 FROM [WJbActions] WHERE (ActionId = 1))
	...
	VALUES (1, N'RunSqlProc', N'RunSqlProcAction, UkrGuru.WebJobs.Actions', N'{
	  "proc": "",
	  "data": null,
	  "timeout": null,
	  "result_name": null
...
IF NOT EXISTS (SELECT 1 FROM [WJbActions] WHERE (ActionId = 2))
	INSERT [WJbActions] ([ActionId], [ActionName], [ActionType], [ActionMore], [Disabled]) 
	VALUES (2, N'SendEmail', N'SendEmailAction, UkrGuru.WebJobs.Actions', N'{
...
IF NOT EXISTS (SELECT 1 FROM [WJbActions] WHERE (ActionId = 3))
	INSERT [WJbActions] ([ActionId], [ActionName], [ActionType], [ActionMore], [Disabled]) 
	VALUES (3, N'FillTemplate', N'FillTemplateAction, UkrGuru.WebJobs.Actions', N'{
