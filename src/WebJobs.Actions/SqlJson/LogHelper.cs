...
namespace UkrGuru.SqlJson
{
    public static class LogHelper
    {
        ...
        public static async Task LogTraceAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Trace, title, more);
        public static async Task LogDebugAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Debug, title, more);
        public static async Task LogInformationAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Information, title, more);
        public static async Task LogWarningAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Warning, title, more);
        public static async Task LogErrorAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Error, title, more);
        public static async Task LogCriticalAsync(this SqlConnection connection, string title, object more = null) => await LogAsync(connection, LogLevel.Critical, title, more);

        public static async Task LogAsync(this SqlConnection connection, LogLevel logLevel, string title, object more = null)
        {
            if ((byte)logLevel < (byte)MinLogLevel) return;
